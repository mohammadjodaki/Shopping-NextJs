...
import Pic1 from "../../Images/pic1black.webp";
import Pic1back from "../../Images/picback1black.png";
import Pic2 from "../../Images/pic1green.webp";
import Pic2back from "../../Images/picback1green.webp";
import Pic3 from "../../Images/pic1blue.webp";
import Pic3back from "../../Images/picback1blue.webp";
import Pic4 from "../../Images/pic1cream.webp";
import Pic4back from "../../Images/picback1cream.webp";
import Pic5 from "../../Images/pic5black.webp";
import Pic5back from "../../Images/picback5black.webp";
import Pic6 from "../../Images/pic5green.webp";
import Pic6back from "../../Images/picback5green.webp";
import Pic7 from "../../Images/pic5cream.webp";
import Pic7back from "../../Images/picback5cream.webp";
import Pic8 from "../../Images/pic8black.webp";
import Pic8back from "../../Images/picback8black.webp";
import Pic9 from "../../Images/pic9blue.webp";
import Pic9back from "../../Images/picback9blue.webp";
import Pic10 from "../../Images/pic10black.webp";
import Pic10back from "../../Images/picback10black.webp";
...
function products1() {
  ...
  const box1 = [  
    ...
    { id: 'Hugger Backpack 25L Blue-blue', src: ColorBlue, idColor: 'blue', imgFront: Pic3, imgBack: Pic3back, name: 'Hugger Backpack 25L Blue', price: 1200 },  
  ...
  const box2 = [  
    ...
    { id: 'Hugger Backpack 35L Midnight-midnight', src: ColorMidnight, idColor: 'midnight', imgFront: Pic6, imgBack: Pic6back, name: 'Hugger Backpack 35L Midnight', price: 500 },  
    { id: 'Hugger Backpack 35L Fogbow-fogbow', src: ColorFogbow, idColor: 'fogbow', imgFront: Pic7, imgBack: Pic7back, name: 'Hugger Backpack 35L Fogbow', price: 500 },  
  ]; 
  const box3 = [  
    { id: 'Ramwerk Backpack 25L Black-black', src: ColorBlack, idColor: 'black', imgFront: Pic8, imgBack: Pic8back, name: 'Ramwerk Backpack 25L Black', price: 400 },  
  ]; 
  const box4 = [  
    { id: 'Roamer Backpack 25L Blue-blue', src: ColorBlue, idColor: 'blue', imgFront: Pic9, imgBack: Pic9back, name: 'Roamer Backpack 25L Blue', price: 350 },  
    { id: 'Roamer Backpack 25L Black-black', src: ColorBlack, idColor: 'black', imgFront: Pic10, imgBack: Pic10back, name: 'Roamer Backpack 25L Black', price: 350 },  
  ];  
    ...
    <div className="w-full h-[1200px] lg:h-[600px] flex flex-wrap">
      <div className="w-1/2 lg:w-1/4 h-1/2 lg:h-full border border-gray-200 group">
        ...
        <div className="w-full flex flex-col h-1/4 px-5 py-2">
          <a className="text-base font-bold" href="#">{selectedImg.name}</a>
          <span className="text-gray-600">{selectedImg.price} kr</span>
      ...
      <div className="w-1/2 lg:w-1/4 h-1/2 lg:h-full border border-gray-200 group">
        ...
        <div className="w-full flex flex-col h-1/4 px-5 py-2">
          <a className="text-base font-bold" href="#">{selectedImg2.name}</a>
          <span className="text-gray-600">{selectedImg2.price} kr</span>
          <div className="flex items-center *:text-base mt-2">
            <StarIcon />
            <StarIcon />
            <StarIcon />
      ...
      <div className="w-1/2 lg:w-1/4 h-1/2 lg:h-full border border-gray-200 group">
        ...
        <div className="w-full flex flex-col h-1/4 px-5 py-2">
          <a className="text-base font-bold" href="#">{selectedImg3.name}</a>
          <span className="text-gray-600">{selectedImg3.price} kr</span>
          <div className="flex items-center *:text-base mt-2">
            <StarIcon />
            <StarIcon />
            <StarIcon />
      ...
      <div className="w-1/2 lg:w-1/4 h-1/2 lg:h-full border border-gray-200 group">
        ...
        <div className="w-full flex flex-col h-1/4 px-5 py-2">
          <a className="text-base font-bold" href="#">{selectedImg4.name}</a>
          <span className="text-gray-600">{selectedImg4.price} kr</span>
          <div className="flex items-center *:text-base mt-2">
            <StarIcon />
            <StarIcon />
            <StarIcon />
